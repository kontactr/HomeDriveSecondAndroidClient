...
public class SignInByRSAUtil {

    public static String postSignInByRSA(String usernameRSA, String keyRSA){

        HttpsURLConnection httpURLConnection = null;
        Log.i("Key",keyRSA);
        Log.i("Key",usernameRSA);
        ...
        try {
            URL url = new URL("https://192.168.225.28:5050/submitRSAkey");
            ...
            writer.write("username="+usernameRSA);
            writer.write("&key="+keyRSA);
            writer.flush();
            writer.close();
            os.close();
            ...
            if (sb.toString().equalsIgnoreCase("Accepted")) {
                Log.i("Result","Accepted");
