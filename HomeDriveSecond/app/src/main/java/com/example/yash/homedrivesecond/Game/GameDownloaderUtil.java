...
public class GameDownloaderUtil {

    public static String getGame(String gameFileName){
      ...
      /*  try {
        ...
        try {
            URL url = new URL("https://192.168.225.28:5050/download/Game");
            ...
            writer.write("radio=Abstract Compress&");
            writer.write("sh_fi="+gameFileName+".apk");
            writer.flush();
            writer.close();
            os.close();
